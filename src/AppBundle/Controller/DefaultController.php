...
//            CURLOPT_URL => "https://maps.googleapis.com/maps/api/place/search/json?keyword=$query&hasNextPage=true&nextPage()=true&sensor=false&key=".Configuration::SearchKey,
        ...
        if ($err) {
            ...
            foreach ($data as $item){
                ...
                if(isset($item['photos'])){
                    ...
                    $place->setPhoto('https://i.imgur.com/lTEiez9.png');
                }
